...
def m2(a, b):
    return ((2*b-3)**(4/5)*(120*b**2+200*b+375)+(2*a-3)**(4/5)*(-120*a**2-200*a-375))/(21*2**(24/5))

def m3(a, b):
    return ((2*b-3)**(4/5)*(1120*b**3+1800*b**2+3000*b+5625)+(2*a-3)**(4/5)*(-1120*a**3-1800*a**2-3000*a-5625))/(133*2**(29/5))

def m4(a, b):
    return ((2*b-3)**(4/5)*(10640*b**4+16800*b**3+27000*b**2+45000*b+84375)+(2*a-3)**(4/5)*(-10640*a**4-16800*a**3-27000*a**2-45000*a-84375))/(399*2**(39/5))

def m5(a, b):
    return ((2*b-3)**(4/5)*(170240*b**5+266000*b**4+420000*b**3+675000*b**2+1125000*b+2109375)+(2*a-3)**(4/5)*(-170240*a**5-266000*a**4-420000*a**3-675000*a**2-1125000*a-2109375))/(3857*2**(44/5))
